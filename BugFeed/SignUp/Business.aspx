          ...
          <div class="card card-border-color card-border-color-primary">
            <div class="card-body">
              ...
              <div class="form-group row sign-up">
                <div class="col-6">
                  <asp:TextBox runat="server" ID="txtBairro" CssClass="form-control" placeholder="Bairro"></asp:TextBox>
                </div>
                <div class="col-6">
                  <asp:TextBox runat="server" ID="txtCidade" TextMode="Url" CssClass="form-control" placeholder="Cidade"></asp:TextBox>
                </div>
              </div>
              <div class="form-group row sign-up">
                <div class="col-6">
                  <asp:TextBox runat="server" ID="txtEstado" CssClass="form-control" placeholder="Estado"></asp:TextBox>
                </div>
                <div class="col-6">
                  <asp:TextBox runat="server" ID="txtPais" TextMode="Url" CssClass="form-control" placeholder="País"></asp:TextBox>
                </div>
              </div>
            </div>
          </div>
